...
public class ComputationServiceTest {
	...
	public void testConvertDecimalToBinary() {
		assertEquals(
				computationService.convertDecimalToBinary("219 to binary"),
				"11011011_2");
		assertEquals(
				computationService.convertDecimalToBinary("4242 to binary"),
				"1000010010010_2");
	}
	...
	public void testConvertUnitAndMeasure() {
		assertEquals(
				computationService
						.convertUnitAndMeasure("120 kilometers to meters"),
				"120000 meters");
		assertEquals(
				computationService
						.convertUnitAndMeasure("160 kilometers to miles"),
				"99.42 miles");
	}
	...
	public void testIncompatibleConversion() {
		assertEquals(
				computationService
						.convertUnitAndMeasure("convert 1024 megabytes to miles"),
				" MB  (megabytes) and  miles are not compatible.");
	}
	...
	private static void setupMockMethods() {
		...
		when(computationEngine.computeOperation("219 to binary")).thenReturn(
				"11011011_2");
		when(computationEngine.computeOperation("4242 to binary")).thenReturn(
				"1000010010010_2");

		when(computationEngine.computeOperation("120 kilometers to meters"))
				.thenReturn("120000 meters");
		when(computationEngine.computeOperation("160 kilometers to miles"))
				.thenReturn("99.42 miles");
		...
		when(
				computationEngine
						.computeOperation("convert 1024 megabytes to miles"))
